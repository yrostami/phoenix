...
app.controller('subscriber', ['$window', '$anchorScroll', '$interval', '$sce', '$rootScope', '$scope', 'userService',
		'ngProgressFactory', subscriber]);
function subscriber($window, $anchorScroll, $interval, $sce, $rootScope, $scope, userService, ngProgressFactory) {
	...
	userService.getSubscriberUser().then(
